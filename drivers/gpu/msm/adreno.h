...
static inline int adreno_is_a660(struct adreno_device *adreno_dev)
{
	...
	return (rev == ADRENO_REV_A660 || rev == ADRENO_REV_A662 ||
		adreno_is_a642(adreno_dev) || adreno_is_a642l(adreno_dev));
}
 ...
 *  A642, A642L,A660, A690 follows the register specs of A650.
 *
 */
static inline int adreno_is_a650_family(struct adreno_device *adreno_dev)
{
	...
	return (rev == ADRENO_REV_A650 || rev == ADRENO_REV_A620 ||
		rev == ADRENO_REV_A660 || rev == ADRENO_REV_A662 ||
		rev == ADRENO_REV_A621 || adreno_is_a642(adreno_dev) ||
